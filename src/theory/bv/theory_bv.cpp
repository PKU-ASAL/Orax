...
void TheoryBV::finishInit()
{
  ...
  if (ee)
  {
    ...
    // orax
    // ee->addFunctionKind(kind::FLOATINGPOINT_SQRT);
    // ee->addFunctionKind(kind::FLOATINGPOINT_ABS);

    // ee->addFunctionKind(kind::FLOATINGPOINT_ISN);
    // ee->addFunctionKind(kind::FLOATINGPOINT_ISSN);
    // ee->addFunctionKind(kind::FLOATINGPOINT_ISINF);
    // ee->addFunctionKind(kind::FLOATINGPOINT_ISNAN);

    // ee->addFunctionKind(kind::FLOATINGPOINT_PLUS);
    // ee->addFunctionKind(kind::FLOATINGPOINT_SUB);
    // ee->addFunctionKind(kind::FLOATINGPOINT_MULT);
    // ee->addFunctionKind(kind::FLOATINGPOINT_DIV);

    // ee->addFunctionKind(kind::FLOATINGPOINT_LEQ);
    // ee->addFunctionKind(kind::FLOATINGPOINT_LT);
    // ee->addFunctionKind(kind::FLOATINGPOINT_GEQ);
    // ee->addFunctionKind(kind::FLOATINGPOINT_GT);

    // ee->addFunctionKind(kind::FLOATINGPOINT_TO_FP_IEEE_BITVECTOR);
    // ee->addFunctionKind(kind::FLOATINGPOINT_TO_FP_FLOATINGPOINT);
    // ee->addFunctionKind(kind::FLOATINGPOINT_TO_FP_SIGNED_BITVECTOR);
    // ee->addFunctionKind(kind::FLOATINGPOINT_TO_FP_UNSIGNED_BITVECTOR);
    // ee->addFunctionKind(kind::FLOATINGPOINT_TO_UBV_TOTAL);
    // ee->addFunctionKind(kind::FLOATINGPOINT_TO_SBV_TOTAL);
  }
}
